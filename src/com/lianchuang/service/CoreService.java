...
//				return MessageResponse.getTextMessage(fromUserName , toUserName , respContent);
	...
	public static void main(String[] args) throws Exception{
				...
				System.out.println("主人，陪我聊聊天吧！");
				String iSaid = reader.readLine();
				while(!iSaid.equalsIgnoreCase("byebye")){
					String tulingSaid = TulingApiProcess.getTulingResult(iSaid);
					System.out.println(tulingSaid);
					iSaid = reader.readLine();
				}
	}
